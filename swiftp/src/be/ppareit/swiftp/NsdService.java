...
/**
 * NsdService registers the FTP server as a discoverable NSD service
 * 
...
public class NsdService extends Service {
    ...
    /**
     * StartStopReceiver is defined in the AndroidManifest.xml, and is used to register 
     * this device with an FTP service for other NSD service seekers to find
     * 
     *  @author David Revell, Pieter Pareit
     *
     */
