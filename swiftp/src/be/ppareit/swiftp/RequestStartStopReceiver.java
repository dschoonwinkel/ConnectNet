...
/**
 * RequestStartStopReceiver is declared in the AndroidManifest.xml, and it listens for broadcasts 
 * to start/stop the {@link be.ppareit.swiftp.FsService} 
 * 
 * @author David Revell, Peter Pareit
 *
 */
