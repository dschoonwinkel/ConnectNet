...
/*
 * OPTS - Cause the server use optional features for the command specified.
 */
...
public class CmdOPTS extends FtpCmd implements Runnable {
    ...
    public void run() {
        ...
        mainBlock: {
            ...
            String optName = splits[0].toUpperCase(Locale.UK);
            String optVal = splits[1].toUpperCase(Locale.UK);
