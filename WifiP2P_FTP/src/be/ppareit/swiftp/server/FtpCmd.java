...
public abstract class FtpCmd implements Runnable {
	...
	protected static CmdMap[] cmdClasses = { new CmdMap("USER", CmdUSER.class),
	...
	public static File inputPathToChrootedFile(File existingPrefix, String param) {
		try {
			if (param.charAt(0) == '/') {
				...
				Log.e(TAG, "Absolute path: " + chroot.toString());
	...
	//Static prototype for all Commands
