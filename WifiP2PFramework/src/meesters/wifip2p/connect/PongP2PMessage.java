...
public class PongP2PMessage extends BaseP2PMessage implements Parcelable, IP2PMessage {
	...
	public PongP2PMessage() {
		//This needs to be initialized to avoid NPEs later. Overwritten with readFromDataStream
		mData = new byte[0];
	}
	
	public PongP2PMessage(String fromAppID, String fromAppUUID, int msgType,
	...
	public static final Parcelable.Creator<PongP2PMessage> CREATOR = new Parcelable.Creator<PongP2PMessage>() {

		@Override
		public PongP2PMessage createFromParcel(Parcel source) {
			...
			return new PongP2PMessage(APP_ID, APP_UUID, msgType, fromDev,
					targetDev, dataLength, data);
		}

		@Override
		public PongP2PMessage[] newArray(int size) {
			return new PongP2PMessage[size];
		}
	};
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PongP2PMessage other = (PongP2PMessage) obj;
		if (mAPP_ID == null) {
