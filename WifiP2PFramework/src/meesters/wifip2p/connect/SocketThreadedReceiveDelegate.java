...
public class SocketThreadedReceiveDelegate {
	...
	public SocketThreadedReceiveDelegate(InputStream in, IP2PMessageThreadedReceiver mP2PMessageReceiver2,
			String name, int threadnumber) {
		mName = name + "." + TAG;
...
//				mP2PMessageReceiver.receiveP2PMessageFromThread(msg, mThreadNumber);
				...
				case Router.MsgType.CONTROL_MESSAGE:
					...
					mP2PMessageReceiver.receiveP2PMessageFromThread(control_msg, mThreadNumber);
					break;
				...
				case Router.MsgType.PONG_MESSAGE:
					...
					mP2PMessageReceiver.receiveP2PMessageFromThread(pong_msg, mThreadNumber);
					break;
				...
				case Router.MsgType.PONG_ANSW_MESSAGE:
					...
					mP2PMessageReceiver.receiveP2PMessageFromThread(pong2_msg, mThreadNumber);
					break;
				}
			} catch (IOException ioe) {
				if (ioe instanceof EOFException) {
//					//This stops reading from this socket as soon as there is no more data...
//					//TODO: consider writing to IControlChannel here that something went wrong...
					break;
				}
				ioe.printStackTrace();
			}
