...
//			logfile.delete();
			...
			File logdir = new File(chrootDir.getAbsolutePath() + "/P2PChatLog");
			logdir.mkdirs();
			GregorianCalendar cal = new GregorianCalendar();
			cal.setTimeInMillis(System.currentTimeMillis());
			File logfile = new File(logdir + "/chat_log" + DateFormat.format("MM-dd-HH.mm.ss", cal) + ".txt");
			Log.v(TAG, logdir + "/chat_log" + DateFormat.format("MM-dd_HH.mm.ss", cal) + ".txt");
			...
			throw new RuntimeException("Unable to create chat_log.txt");
		}
	}
